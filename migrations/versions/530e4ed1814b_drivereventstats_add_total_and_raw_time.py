"""DriverEventStats, add total and raw time

Revision ID: 530e4ed1814b
Revises: 3e2973d962a4
Create Date: 2025-04-21 23:12:56.309754
...
revision = '530e4ed1814b'
down_revision = '3e2973d962a4'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('fastest_lap', sa.Float(), nullable=False),
    sa.Column('average_lap', sa.Float(), nullable=False),
    sa.Column('total_laps', sa.Integer(), nullable=False),
    sa.Column('raw_time', sa.Float(), nullable=False),
